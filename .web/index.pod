...
These are some bindings of OCaml and Perl in the style of C<ctypes>.

L<Git repository|https://github.com/pippijn/perltypes>
...
=begin code ocaml
   ...
   let say =
     foreign "say" (string @-> float @-> int @-> int)

   let test_invoke1 =
     foreign "test_invoke1" ((string @-> string) @-> string)

   let test_invoke2 =
     foreign "test_invoke2" ((string @-> string @-> string) @-> string)
